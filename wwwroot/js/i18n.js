(function () {
  ...
  const exact = {
    ...
    "BuildTaskFlow Gantt": "BuildTaskFlow Gantt",
    ...
    "Proje, görev ve ekip üyesi bazlı tarih çizelgesi ve tamamlanma yüzdeleri.": "Project, task and team member timeline with completion percentages.",
    "Gantt": "Gantt",
    "Gantt Tarih Aralığı": "Gantt Date Range",
    "Genel Tamamlanma": "Overall Completion",
    "Proje ve Görev Gantt Şeması": "Project and Task Gantt Chart",
    "Her çubuk başlangıç tarihi, bitiş/teslim tarihi ve tamamlanma yüzdesini gösterir.": "Each bar shows start date, end/due date and completion percentage.",
    "Ekip Üyesine Göre Tamamlanma": "Completion by Team Member",
    "Kişilere atanmış görevlerin sayısı ve ortalama tamamlanma yüzdesi.": "Assigned task count and average completion percentage by person.",
    "Ekip Üyesi Bazlı Gantt": "Team Member Based Gantt",
    "Aynı görev tarihleri bu kez görev alan kişilere göre gruplanmıştır.": "The same task dates are grouped by assigned team member.",
    ...
    "Görev Tamamlanma Oranı": "Task Completion Rate",
