...
public class EditModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync(int id)
    {
        ...
        TaskItem = task;
        AssignedTeamMemberId = task.Assignments.FirstOrDefault()?.BuildTaskFlowTeamMemberId;
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        var existingTask = await _context.BuildTaskFlowTasks
        ...
        existingTask.BuildTaskFlowProjectId = TaskItem.BuildTaskFlowProjectId;
        existingTask.BuildTaskFlowTaskStatusId = TaskItem.BuildTaskFlowTaskStatusId;
        ...
        if (AssignedTeamMemberId.HasValue)
        {
            ...
            {
                BuildTaskFlowTaskId = existingTask.Id,
