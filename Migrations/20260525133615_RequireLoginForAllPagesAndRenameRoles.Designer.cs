...
namespace ConstructionManagementSystem.Migrations
{
    ...
    [Migration("20260525133615_RequireLoginForAllPagesAndRenameRoles")]
    partial class RequireLoginForAllPagesAndRenameRoles
    {
            ...
            modelBuilder.Entity("ConstructionManagementSystem.Models.BuildTaskFlowTeamMember", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 6,
                            BuildTaskFlowRoleId = 6,
                            CreatedAt = new DateTime(2026, 5, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "goruntuleyici@buildtaskflow.local",
                            FullName = "Can Görüntüleyici",
                            IsActive = true,
                            PasswordHash = "8D969EEF6ECAD3C29A3A629280E686CF0C3F5D5A86AFF3CA12020C923ADC6C92",
